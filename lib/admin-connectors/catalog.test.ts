...
describe("admin connector catalog", () => {
  ...
  it("routes Jira, GitHub, GitLab, Bitbucket, Teams, IMAP, Slack, and S3 through the Connectors wizard", () => {
    for (const id of ["jira", "github", "gitlab", "bitbucket", "teams", "imap", "slack", "s3"] as const) {
